...
> [!NOTE]
> 한국어 번역은 현재 **들어가며와 1장**까지 제공됩니다. 2~10장의 한국어 본문은 번역이 추가되는 대로 이 README에도 반영할 예정입니다. 전체 내용이 필요하면 [중국어 원문](book/) 또는 [영문판](book-en/)을 참고하세요.
...
3. [실험 1-1](chapter1/context/)로 컨텍스트 구성 요소를 비교합니다.
4. [실험 1-2](chapter1/web-search-agent/)로 ReAct 궤적을 관찰합니다.
5. [실험 1-3](chapter1/search-codegen/)으로 모델의 네이티브 도구 호출 구조를 확인합니다.
6. 1장 끝의 **이 장의 요약**과 **생각해 볼 문제**로 스스로 설명해 봅니다.
...
| 2 | 컨텍스트 엔지니어링 | 메시지 구조, KV Cache, 프롬프트, Skills, 컨텍스트 압축 | 번역 예정 |
...
한국어 본문이 아직 없는 장도 [`chapter2`](chapter2/)부터 [`chapter10`](chapter10/)까지의 실습 코드는 먼저 살펴볼 수 있습니다. 각 프로젝트의 실행 조건은 해당 디렉터리의 README를 확인하세요.
