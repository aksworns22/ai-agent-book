...
1. **Thử thách lựa chọn công cụ**: Khi tài liệu về hàng nghìn công cụ đủ để lấp đầy cửa sổ ngữ cảnh, làm thế nào Agent có thể tìm thấy công cụ cần thiết một cách chính xác và hiệu quả để hoàn thành nhiệm vụ? Làm thế nào để phát triển từ các công cụ “chọn lọc” thụ động sang các công cụ “khám phá” và “học hỏi” chủ động? Chương này tập trung vào các nguyên tắc thiết kế và hiện trạng sinh thái của công cụ; giải pháp hoàn chỉnh về khám phá tích cực và tạo công cụ sẽ được chuyển sang Chương 8.
...
Việc nêu rõ cấu trúc phân loại trong các system prompt có thể giúp LLM nhanh chóng xác định được nhóm công cụ liên quan. Một giải pháp nữa là **khám phá công cụ động** được xem trước trong "Sự phát triển của thiết kế công cụ" trước đó: thay vì đưa tất cả các định nghĩa công cụ vào ngữ cảnh cùng một lúc, Agent cho phép Agent khám phá các định nghĩa công cụ theo yêu cầu (xem Chương 8 để biết chi tiết). Khi có hàng trăm công cụ có sẵn, việc xếp chúng vào ngữ cảnh sẽ gây lãng phí mã thông báo và cản trở việc ra quyết định. Các thử nghiệm của Anthropic cho thấy phương pháp truy xuất theo yêu cầu này cải thiện độ chính xác của Opus 4 trên điểm chuẩn sử dụng công cụ từ 49% lên 74%.
...
>
>
> ![Hình 4-1 Thời gian tương tác giao thức MCP ](images_vi/fig4-1.svg)
>
>
...
![Hình 4-2 Policy chuyển ngữ cảnh của Tác nhân phụ ](images_vi/fig4-2.svg)
...
![Hình 4-3 Kiến trúc tác nhân không đồng bộ hướng sự kiện ](images_vi/fig4-3.svg)
...
![Hình 4-4 Ba chiến lược xử lý sự kiện không đồng bộ ](images_vi/fig4-4.svg)
...
>
>
> ![Hình 4-5 Thí nghiệm 4-4 Kiến trúc Agent hướng sự kiện ](images_vi/fig4-5.svg)
>
>
...
![Hình 4-6 Mô hình đào tạo đồng bộ và thực tế triển khai không đồng bộ ](images_vi/fig4-6.svg)
...
>
>
> ![Hình 4-7 Thí nghiệm 4-5 Ngắt và phục hồi tác nhân không đồng bộ ](images_vi/fig4-7.svg)
>
>
...
Năm thử nghiệm tiến triển dần dần từ cơ bản đến kiến trúc: Thử nghiệm 4-1 đến Thử nghiệm 4-3 xây dựng ba bộ công cụ cơ bản về nhận thức, thực thi và cộng tác. Thử nghiệm 4-4 sử dụng xử lý email. Agent giới thiệu ổ sự kiện. Thử nghiệm 4-5 triển khai thực thi song song, khôi phục gián đoạn và quản lý trạng thái. Thiết kế công cụ và kiến trúc được thảo luận trong chương này—giao thức MCP, nguyên tắc thiết kế và kiến trúc không đồng bộ—là điều kiện tiên quyết cho quá trình tự phát triển của Agent trong Chương 8.
